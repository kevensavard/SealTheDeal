...
export async function sendEmail(options: EmailOptions): Promise<boolean> {
  ...
  try {
    const msg = {
      from: options.from || `SealTheDeal <contracts@mail.sealthedeal.app>`,
  ...
  const html = `
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>If you have any questions about this contract, please contact ${data.senderName} at <a href="mailto:support@mail.sealthedeal.app">support@mail.sealthedeal.app</a>.</p>
      </div>
...
If you have any questions, please contact ${data.senderName} at <a href="mailto:support@mail.sealthedeal.app">support@mail.sealthedeal.app</a>.
