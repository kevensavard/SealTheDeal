...
export async function sendEmail(options: EmailOptions): Promise<boolean> {
  ...
  try {
    const msg = {
      from: options.from || `SealTheDeal <noreply@${process.env.MAILGUN_DOMAIN}>`,
  ...
  const html = `
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>If you have any questions about this contract, please contact ${data.senderName} at ${data.senderEmail}.</p>
      </div>
