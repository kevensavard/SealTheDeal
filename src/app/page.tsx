        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Multi-Party E-Signatures</h3>
              <p className="text-slate-300 leading-relaxed">
                Send contracts for digital signatures with password protection, IP-based location tracking, and automatic final PDF distribution to all parties.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Smart Client Management</h3>
              <p className="text-slate-300 leading-relaxed">
                Store client information with auto-fill capabilities. Link contracts directly to client profiles for seamless contract creation.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <p className="text-slate-300 leading-relaxed">
                Pre-built contract templates for common scenarios. Customize with AI assistance and save your own templates for future use.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <p className="text-slate-300 leading-relaxed">
                Track contract performance, conversion rates, turnaround times, and business metrics with detailed analytics and visual charts.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Smart Notifications</h3>
              <p className="text-slate-300 leading-relaxed">
                Real-time activity feed with contract status updates, signature reminders, expiration alerts, and system notifications.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">PDF Export & Email</h3>
              <p className="text-slate-300 leading-relaxed">
                Download professional PDFs with embedded signatures, or send contracts directly via email with tracking and delivery confirmation.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <p className="text-slate-300 leading-relaxed">
                Full interface available in English, French, and Spanish. AI-generated contracts adapt to your language preference.
              </p>
            </div>
            ...
            <div className="bg-slate-700 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-slate-600">
              ...
              <p className="text-slate-300 leading-relaxed">
                GDPR-compliant data protection, encrypted storage, secure authentication, and comprehensive audit trails for all contract activities.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl border-2 border-dashed border-slate-600">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Industry-Specific Packs</h3>
              <p className="text-slate-300 leading-relaxed">
                Specialized contract bundles for real estate, healthcare, technology, and other industries with tailored clauses and terms.
              </p>
            ...
            <div className="text-center p-8 rounded-2xl border-2 border-dashed border-slate-600">
              ...
              <h3 className="text-xl font-bold text-white mb-4">AI Legal Assistant</h3>
              <p className="text-slate-300 leading-relaxed">
                Advanced AI that reviews contracts for potential issues, suggests improvements, and ensures compliance with local laws.
              </p>
            ...
            <div className="text-center p-8 rounded-2xl border-2 border-dashed border-slate-600">
              ...
              <p className="text-slate-300 leading-relaxed">
                Multi-user workspaces with role-based permissions, collaborative editing, and team contract management for larger organizations.
              </p>
